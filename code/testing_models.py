...
feature_col=['cs'] #feature
predicted=['category'] #target try for - complaint and category
...
svclassifier.fit(Train_X_Tfidf, y_train) 
print(confusion_matrix(y_test,y_pred))
print(classification_report(y_test,y_pred))
nb_model=GaussianNB()
nb_model.fit(Train_X_Tfidf,y_train.ravel())
prediction_from_train=nb_model.predict(Train_X_Tfidf)
accuracy=metrics.accuracy_score(y_train,prediction_from_train)
